...
* rilcoin.conf: contains configuration settings for rilcoind or rilcoin-qt
* rilcoind.pid: stores the process id of rilcoind while running
...
* debug.log: contains debug information and general logging generated by rilcoind or rilcoin-qt
