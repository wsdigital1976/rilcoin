Rilcoin Core version 0.10.2.2 is now available from:

  <https://download.rilcoin.org/rilcoin-0.10.2.2/>
...
- Rilcoin TCP port 26580 (instead of 8333)
- RPC TCP port 26579 (instead of 8332)
- Testnet TCP port 126580 (instead of 18333)
- Testnet RPC TCP port 36579 (instead of 18332)
...
- Rilcoin Core v0.10.2.2 is protocol version 70003 (instead of 70002)
