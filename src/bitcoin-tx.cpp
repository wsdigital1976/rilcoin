...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rilcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rilcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rilcoin transaction") + "\n" +
              "  rilcoin-tx [options] -create [commands]   " + _("Create hex-encoded rilcoin transaction") + "\n" +
              "\n";
